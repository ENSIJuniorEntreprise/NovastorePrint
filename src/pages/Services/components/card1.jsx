...
function Card1() {
  ...
  const images = stores.map((store) => store.image);
        ...
        <div>
          <CardContent sx={{ textAlign: "center" }}>
            ...
            <StyledSub sx={{ marginBottom: "1vw" }} variant="subtitle1">
              Nos stores et abris sur mesure sont conçus pour s'adapter à toutes les ouvertures, qu'il s'agisse de terrasses, de fenêtres ou de jardins, afin de répondre parfaitement à vos besoins.
            </StyledSub>
